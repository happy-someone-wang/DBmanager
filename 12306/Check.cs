...
namespace Check
{
    ...
    class checkUser
    {
        ...
        public static int checkChgPwd(string UserPwd)
        {
            int ret = -1;
            if ((ret = checkUserPWD(UserPwd)) != -1)
            {
                return ret;
            }
        ...
        public static int checkPassenger(_Passenger P)
        {
            int ret = -1;
            if ((ret = checkUserPID(P.PassengerPID)) != -1)
            {
                return ret;
            }

            if ((ret = checkUserRName(P.PassengerRName)) != -1)
            {
                return ret;
            }
